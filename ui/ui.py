...
upload_submit_button = dbc.Button("Upload", size="me-1", className="me-1", style={"margin": "10px 35%",
...
app.layout = html.Div(children=[
    ...
    dbc.Row([dbc.Col([drop_box, upload_submit_button], width=3, style={"display": "flex",
...
app.layout.children.append(dcc.Store(id="chat-store", data=[]))
